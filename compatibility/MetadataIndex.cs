...
public sealed record BindingContract(int Schema,TypeContract[] Types,ApiContract[] Apis,Dictionary<string,string> Roles,Dictionary<string,long>? TileKinds=null);
